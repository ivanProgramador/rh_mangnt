                        ...
                        @else
                          <div class="d-flex gap-3 justify-content-end">
                            ...
                            @if(empty($colaborator->deleted_at))
                              ...
                              <a href="{{ route('rh.management.details',['id' => $colaborator->id]) }}" class="btn btn-sm btn-outline-dark"><i class="fas fa-eye me-2"></i>Detalhes</a>

                            @else
                               <a href="{{ route('rh.management.restore',['id' => $colaborator->id]) }}" class="btn btn-sm btn-outline-dark"><i class="fa-solid fa-trash-arrow-up me-2"></i>Restaurar</a>
                            @endif  
                          </div>
                        @endif
